<?php
	...
	echo "<form name='submitRole' id='submitRole'>";
		...
		echo "<table width='500'>";
			...
			echo "<tr >
					<td style='border-bottom-width:1px;border-bottom-style:dotted;' colspan='2' align='right'><a href='javascript:void(0)' onClick='closeRegPrompt()'>Close</a></td>
		  		  </tr>";
			
			// This is the line of meeting date
			echo "<tr><td style='width:150px'>MeetingDate: </td><td><label for='submitRole' id='meetingdate' value='".$meetingDate."'>".$meetingDate."</label></td></tr>";
...
// 							<td id='inputContactInfo'></td></tr>";
					echo "<tr>
							<td>&nbsp;</td>
							<td id='inputOther'><font color='red'><label id='example'>Example: 1 (1 is Lila Duanmu)</label></font></td>
					  	  </tr>";
				}
			}
	...
	if(RoleNames::isRoleTypeCC($keyOfRoleName)){
		...
		if(RoleNames::isTme($keyOfRoleName)){
			...
			if(isset($sqlObject) && ($sqlObject->theme != "") && ($sqlObject->theme != null)){
				echo "<tr><td>Theme of this meeting: </td><td>".$sqlObject->theme."</td></tr>";
			} else {
				echo "<tr><td>Theme of this meeting: </td><td><input type='text' style='width:250px' size='150' id='themevalue' /></td></tr>";
			}
...
// 				echo "<tr><td>Theme of this meeting: </td><td><input type='text' style='width:250px' size='150' id='themevalue' ".(isset($sqlObject)?("value='".$sqlObject->theme."'"):"")." /></td></tr>";
	...
	echo "<tr>
			...
			if((!isset($_SESSION["USERNAME"])) || (isset($_SESSION["USERNAME"]) && (RoleNames::isTheme($keyOfRoleName))))
				echo "<input type='reset' name='cancel' id='cancel' value='Reset'/>&nbsp;";
			elseif (isset($_SESSION["USERNAME"]) && (RoleNames::isRoleTypeCCOrCL($keyOfRoleName))){
				echo "<input type='button' name='cancel' id='roleRegReset' value='Reset' onClick=\"resetRegForm('submitRole', 'inputkey', 'inputvalue')\"  />&nbsp;";
			}
	
	echo "<input type='button' 
		name='submit' value='Submit' onClick=\"submitReg('".$meetingDate."','".$keyOfRoleName."','inputkey','inputvalue','".$levelIdentify."','".$projectIdentify."')\" /></td></tr>";
